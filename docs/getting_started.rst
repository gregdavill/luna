...
-  A working installation of
   `Amaranth <https://github.com/amaranth-lang/amaranth>`__. Note that only the
   official toolchain from `@Amaranth <https://github.com/amaranth-lang>` is
...
program gateware using Amaranth; so they can be run like any other script:
